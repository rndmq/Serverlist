...
--[[
	...
	The main explorer interface
		...
		local function main()
			...
			Explorer.ViewWidth = 300
			Explorer.Index = 0
			Explorer.EntryIndent = 20
			Explorer.FreeWidth = 300
			Explorer.GuiElems = {}
...
--[[
	...
	The main properties interface
		...
		local function main()
			...
			Properties.GuiElems = {}
			Properties.Index = 0
			Properties.ViewWidth = 300
			Properties.MinInputWidth = 300
...
--[[
	...
	Container for functions and classes
		...
		local function main()
			...
			Lib.Window = (function()
				local funcs = {}
				local static = {MinWidth = 300, FreeWidth = 300}
				local mouse = plr:GetMouse()
